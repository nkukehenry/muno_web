		...
		<div class="card card-body">
			 <form class="row" action="<?php echo base_url(); ?>stats/payments/received/filter" method="get">
	        			<fieldset>
	        				<legend>
		        			...
		        			<div class="form-group col-md-4">
		        				...
		        				<td><input class="form-control"  type="text" name="sdate" class="datepicker" /></td>
		        			</div>
		        			<div class="form-group col-md-4">
		        				<label>End Date:</label>
		        				<input class="form-control"  type="text" name="edate" class="datepicker" />
		        			</div>
		        			<div class="form-group col-md-4" >
		        				<input class="form-control"  type="submit" name="submit_borrower" value="Submit" />
		        			</div>
		        		</fieldset>
	        		</form> 
		</div>
