...
define('ICON_URL', ASSET_URL."icon/");
define('PAGE_URL', ASSET_URL."page/");
define('BOWER', ASSET_URL."bower_components/");
define('SYS_NAME', 'Muno Loans');
...
|
*/
$config['encryption_key'] = 'YzSljaiHrIvYkSQm2ob1Mg1aesUUDahI';
